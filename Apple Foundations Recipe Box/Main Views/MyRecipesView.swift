...
struct MyRecipesView: View {
    ...
    var filteredRecipeIndices: [Int] {
        ...
        return recipeData.recipes.indices.filter { index in
            ...
            recipe.name.localizedCaseInsensitiveContains(trimmedSearchText) && recipe.isSaved == true ||
            ...
            return matchesSearch && matchesTags && matchSaved
        }
    }
